...
def get_available_hosts():
    hosts = ['10.0.71.2', '192.168.82.52', '192.168.82.26']  # Accessible Client List
    http_host = request.env.http_host.split(':')[0]
    try:
        import socket
        hosts.extend([http_host, socket.gethostname(), socket.gethostbyname(http_host),
...
if request.env.http_x_forwarded_for or request.is_https or request.is_local \
   or DEMO_MODE or request.env.remote_addr in get_available_hosts():
