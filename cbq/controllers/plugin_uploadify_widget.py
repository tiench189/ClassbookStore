...
FILES = (
    URL(APP, 'static', 'plugin_uploadify_widget/uploadify.css'),
    URL(APP, 'static', 'plugin_uploadify_widget/swfobject.js'),
    URL(APP, 'static', 'plugin_uploadify_widget/jquery.uploadify.v2.1.4.min.js'),
    URL(APP, 'static', 'plugin_uploadify_widget/uploadify.css'),
)
...
""" % dict(id=_id, file_id=_file_id,
           ...
           uploader=URL(APP, 'static', 'plugin_uploadify_widget/uploadify.swf'),
           script=URL(args=current.request.args),
           extra_vars=json.dumps(attributes.get('extra_vars', {})),
           cancel_img=URL(APP, 'static', 'plugin_uploadify_widget/cancel.png'),
           fileext=fileext,
