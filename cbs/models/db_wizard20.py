...
db.define_table('clsb20_product_cp',
                Field('product_category', type='reference clsb_category', notnull=True, label=T('Danh mục')),
                ...
                Field('product_title', type='string', notnull=True, label=T('Tiêu đề sản phẩm')),
                Field('product_description', type='text', label=T('Product description')),
                Field('product_code', type='string', notnull=True, unique=True, label=T('Mã sản phẩm')),
                Field('product_status', type='string', notnull=True, default='Init',
                      requires=IS_IN_SET(['Init', 'Submit', 'Published', 'Cancel', 'Reject', 'CPDelete'],
                                         zero='Choose status:'), label=T('Trạng thái')),
                Field('product_price', type='integer', default=0, label=T('Giá tiền')),
...
db.define_table('clsb20_product_metadata_cp',
                Field('product_code', type='string', notnull=True, label=T('Mã sản phẩm')),
                Field('metadata_id', type='reference clsb_dic_metadata', notnull=True, label=T('Thuộc tính')),
                Field('metadata_value', type='text', notnull=True, label=T('Giá trị')),
                auth.signature)
