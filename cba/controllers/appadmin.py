...
hosts = ['192.168.56.81', '10.0.71.2']  # Accessible Client List
...
if request.env.http_x_forwarded_for or request.is_https or request.is_local or request.env.remote_addr in hosts:
