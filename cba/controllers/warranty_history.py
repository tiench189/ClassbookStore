...
def index():
    current_table = "clsb_warranty_history"
#     if request.url.find('/clsb_warranty_history/clsb_product.') >= 0:
#         current_table = "clsb_product"
#     print current_table
    selectable = lambda ids: delete(ids, current_table)

    form = smartgrid(db.clsb_warranty_history, 
                             oncreate = history_on_create,
                             onupdate = history_on_update,
                             ondelete = history_on_delete,
